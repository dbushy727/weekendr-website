...
<html>
    ...
    <body class="is-preload">
        ...
        <!-- Header -->
            <header id="header">
                <div class="content">
                    <img class="logo" src="/images/new-logo-big.png" alt="">
                    <h1><a href="/">Weekendr</a></h1>
                    <p>Friday to Sunday roundtrip tickets for under $200</a></p>
                    <ul class="actions">
                        <li><a href="#" class="button primary">Sign up for free</a></li>
                        <li><a href="#one" class="button icon fa-chevron-down scrolly">Learn more about Pro</a></li>
                    </ul>
                </div>
            </header>
